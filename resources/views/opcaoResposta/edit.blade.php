...
@section('content')
    ...
    <form class="form-horizontal" action="{{Route('opcaoRespostas.update',["Opcoes"=>$Opcao->id])}}" method="post">
        ...
        <div class="form-group bg-light p-2 rounded">
            ...
            <input type="text" class="form-control" id="razao_social" placeholder="{{$Opcao->id_pergunta}}" name="id_pergunta" required>

            <label  for="cnpj">Opcao:</label>
            <input type="text" class="form-control" id="cnpj" placeholder="{{$Opcao->opcao}}" name="opcao" required>
